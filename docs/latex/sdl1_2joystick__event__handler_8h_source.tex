...
\hypertarget{sdl1_2joystick__event__handler_8h_source}{}\label{sdl1_2joystick__event__handler_8h_source}\index{include/core/apis/sdl1/joystick\_event\_handler.h@{include/core/apis/sdl1/joystick\_event\_handler.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#ifndef\ JOYSTICK\_EVENT\_HANDLER\_API\_SDL\_1\_H}}
\DoxyCodeLine{00002\ \textcolor{preprocessor}{\#define\ JOYSTICK\_EVENT\_HANDLER\_API\_SDL\_1\_H}}
\DoxyCodeLine{00003\ }
...
\DoxyCodeLine{00170\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ SDL\_JoystickName(index);}
...
\DoxyCodeLine{00381\ \ \ \ \ \}}
\DoxyCodeLine{00382\ }
\DoxyCodeLine{00383\ \ \ \ \ \textcolor{comment}{//\ TRIGGER\_PRESSED\_JOYSTICKS\_BUTTONS();}}
\DoxyCodeLine{00384\ \}}
\DoxyCodeLine{00385\ }
\DoxyCodeLine{00391\ \textcolor{keywordtype}{void}\ closeJoystickEventHandler()}
\DoxyCodeLine{00392\ \{}
\DoxyCodeLine{00393\ \ \ \ \ \textcolor{keywordflow}{if}\ (!gJoysticks)}
\DoxyCodeLine{00394\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{goto}\ close\_sdl\_joystick\_subsystem;}
\DoxyCodeLine{00395\ }
\DoxyCodeLine{00396\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ joystickIterator\ =\ 0;\ joystickIterator\ <\ maxJoysticks;\ joystickIterator++)}
\DoxyCodeLine{00397\ \ \ \ \ \{}
\DoxyCodeLine{00398\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (gJoysticks[joystickIterator]\ !=\ NULL)}
\DoxyCodeLine{00399\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00400\ \ \ \ \ \ \ \ \ \ \ \ \ SDL\_JoystickClose(gJoysticks[joystickIterator]);}
\DoxyCodeLine{00401\ \ \ \ \ \ \ \ \ \ \ \ \ gJoysticks[joystickIterator]\ =\ NULL;}
\DoxyCodeLine{00402\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00403\ \ \ \ \ \}}
\DoxyCodeLine{00404\ \ \ \ \ free(gJoysticks);}
\DoxyCodeLine{00405\ \ \ \ \ gJoysticks\ =\ NULL;}
\DoxyCodeLine{00406\ close\_sdl\_joystick\_subsystem:}
\DoxyCodeLine{00407\ \ \ \ \ releaseJoysticksCurrentStateArray();}
\DoxyCodeLine{00408\ \ \ \ \ releaseJoystickButtonsPressedFlagsArray();}
\DoxyCodeLine{00409\ \ \ \ \ SDL\_QuitSubSystem(SDL\_INIT\_JOYSTICK);}
\DoxyCodeLine{00410\ }
\DoxyCodeLine{00411\ \ \ \ \ \textcolor{keywordflow}{if}\ (gJoyStickEventManager.listsCount\ >\ 0)}
\DoxyCodeLine{00412\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{event__manager_8h_a94559910de43732dc2da469b42f69298}{freeEventManager}}(\&gJoyStickEventManager,\ \textcolor{keyword}{true});}
\DoxyCodeLine{00413\ \}}
\DoxyCodeLine{00414\ }
