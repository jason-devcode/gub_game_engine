...
Vec2f trianglePoints[] = {{200, 200}, {400, 200}, {200, 400}};
...
void *gameLoop(void *arg)
{
    ...
    do
    {
        ...
        drawRectangleWire(100, 100, 540, 540, BLUE_500);
        drawTriangleScreenClippingDepthTest(
            trianglePoints[0].x, trianglePoints[0].y, 1,
            trianglePoints[1].x, trianglePoints[1].y, 2,
            trianglePoints[2].x, trianglePoints[2].y, 2,
            YELLOW_200); 
